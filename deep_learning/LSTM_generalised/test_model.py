...
data_path = "../Trash/LSTM_3_classes/test_data/4.60_processed.csv"  # Adjust this path to your data file
data = pd.read_csv(data_path)

# Model loading
model = load_model('model_generalized_200ep_32units.h5')
...
results_file_path = 'pred_gen2.csv'
